...
import {
  ...
  getServicesHealth, getExperiments, synthesizeTTS,
...
// Bloc 'Traffic Live tab' retire — voir docker-compose.yml (service watcher desactive)

// ── Tab list item ─────────────────────────────────────────────────────────────
const TAB_ITEMS = [
  { value: "overview",     label: "Vue générale" },
  { value: "traces",       label: "Traces & Modèles" },
  // "traffic" retire avec la desactivation du service watcher (v0.2)
...
export default function AdminPage() {
  ...
  // Traffic live state retire avec la desactivation du service watcher (v0.2)
