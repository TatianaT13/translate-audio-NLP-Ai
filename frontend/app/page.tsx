        ...
        {open && (
          <div style={{
            ...
            {[
              ...
              { label: "Soutenance · pitch (13 slides)", action: () => { window.open("/soutenance-pitch.html", "_blank", "noopener,noreferrer"); setOpen(false); }, color: "var(--accent)" },
              { label: "Soutenance · support complet", action: () => { window.open("/soutenance.html", "_blank", "noopener,noreferrer"); setOpen(false); }, color: "var(--accent)" },
