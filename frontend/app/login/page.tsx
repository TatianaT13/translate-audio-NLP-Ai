...
// Le formulaire est extrait dans son propre composant pour pouvoir etre
// wrapp dans <Suspense> — requis par Next.js 15 des qu'on utilise
// useSearchParams() dans une page prerender.
function LoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // ?next=/xxx passe par la landing depuis une card qui necessite auth
...
export default function LoginPage() {
  return (
    <main style={{
      ...
      <Suspense fallback={<div style={{ color: "var(--muted)", fontSize: "13px" }}>Chargement…</div>}>
        <LoginForm />
      </Suspense>
      <Footer />
    </main>
